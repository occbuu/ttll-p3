...
Table 2  Recorded reasons and denominators
...
Table 3  Historical mapping and feature definitions
...
Table 4  Distance by recorded reason
...
![Cumulative distance distributions by recorded reason. Axes display 0–2,000 m; all distances enter the analysis. Network coverage differs from straight-line coverage. Overlap is not evidence of equivalence. Source: TTLL 2023 resident survey and OpenStreetMap contributors.](analysis/Figure2_accessibility.png)

![Recorded reasons among 439 respondents giving a substantive reason. Mutually exclusive responses, not independent estimates of all barriers.](analysis/Figure1_reasons.png)
...
Table 5  Walking discomfort versus other reasons
